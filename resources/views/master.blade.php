...
<head>
    ...
    <title>DAGA capital – Inversiones</title>
        ...
        <div class="navbar navbar-fixed-top" role="banner">
            <div class="container">
                <div class="navbar-header scroll">
                    ...
                    <a class="navbar-brand" href="{{ url('/') }}/#navigation"><h1><img src="{{ asset('images/logo.png') }}" alt="Logo Daga Capital" width="250"></h1></a>
                </div>
                <div class="collapse navbar-collapse">
                    <ul class="nav navbar-nav navbar-right">
                        <li class="scroll {{ $section == 'home' ? 'active' : '' }}"><a href="{{ url('/') }}/#navigation">Home</a></li>
